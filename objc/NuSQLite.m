...
//  NuSQLite.m
//
//  Created by Tim Burks on 7/20/10.
//

#import "NuSQLite.h"

@interface NuSQLite(PrivateMethods)
- (void) open;
...
{
	[NSException raise:@"NuSQLiteException" format:errorMessage, sqlite3_errmsg16(database)];
}
